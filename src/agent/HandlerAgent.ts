...
export class HandlerAgent {
     ...
     *
     */
    constructor(private agentName: string, private handle: string, private password: string, agent: BskyAgent | null = null) {
        if (!agent) {
     ...
     *
     */
    async createSkeet(newPostDetails: string, existingPostDetails: PostDetails | null = null) {
