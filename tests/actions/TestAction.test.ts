import {HandlerAgent, JetstreamMessage, LogMessageAction, TestAction} from "../../src";
...
describe("TestAction", () => {
    ...
    it("Should log Working", async () => {
        ...
        expect(console.log).toHaveBeenCalledWith("1/31/2023, 07:00 PM | Working | INFO | working");
    });
});