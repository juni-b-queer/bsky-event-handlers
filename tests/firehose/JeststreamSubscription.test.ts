...
describe('JetstreamSubscription', () => {
    ...
    beforeEach(() => {
        jetSub = new JetstreamSubscription(handlers, 'ws://localhost:6008/subscribe');
    ...
    test('handleCreate post', () => {
        ...
        const msg: CreateMessage = {
            collection: "app.bsky.feed.post", did: "", opType: "c", record: {} as Record, rkey: "", seq: 0
    ...
    test('handleCreate like', () => {
        ...
        const msg: CreateMessage = {
            collection: "app.bsky.feed.like", did: "", opType: "c", record: {} as Record, rkey: "", seq: 0
    ...
    test('handleCreate repost', () => {
        ...
        const msg: CreateMessage = {
            collection: "app.bsky.feed.repost", did: "", opType: "c", record: {} as Record, rkey: "", seq: 0
    ...
    test('handleCreate follow', () => {
        ...
        const msg: CreateMessage = {
            collection: "app.bsky.graph.follow", did: "", opType: "c", record: {} as Record, rkey: "", seq: 0
    ...
    test('handleDelete post', () => {
        ...
        const msg: DeleteMessage = {
            collection: "app.bsky.feed.post", did: "", opType: "d", rkey: "", seq: 0
    ...
    test('handleDelete like', () => {
        ...
        const msg: DeleteMessage = {
            collection: "app.bsky.feed.like", did: "", opType: "d", rkey: "", seq: 0
    ...
    test('handleDelete repost', () => {
        ...
        const msg: DeleteMessage = {
            collection: "app.bsky.feed.repost", did: "", opType: "d", rkey: "", seq: 0
    ...
    test('handleDelete follow', () => {
        ...
        const msg: DeleteMessage = {
            collection: "app.bsky.graph.follow", did: "", opType: "d", rkey: "", seq: 0
